        ...
        <BreadcrumbList>
          ...
          {currentView === 'flow' && (
            <>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link href="#" onClick={() => onViewChange('flow')} className="text-gray-600 hover:text-gray-900">
                    Flow
                  </Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
           ...
           {currentView === 'aiphone' && (
            <>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link href="#" onClick={() => onViewChange('aiphone')} className="text-gray-600 hover:text-gray-900">
                    AI Phone
                  </Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
